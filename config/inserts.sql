...
------------------------------------------------------------
--- # Tablas de referencia de persona
------------------------------------------------------------
...
INSERT INTO eps (nombre)
    ...
    ('Póliza De Salud De Seguros De Vida Sura'),
    ('Salud Total'),
    ('Sura Eps'),
    ('Familias Saludables'),
    ('Sin Dato'),
...
INSERT INTO tipos_peticion (nombre)
VALUES
    ('Petición'),
    ('Queja'),
    ('Reclamo'),
...
VALUES
    ...
    ('Llamada Telefónica'),
    ('Página Web'),
    ('Verbal y/o Presencial'),
    ('EPS O Asegurador'),
    ('Conexiones Savia'),
    ('Sura web');
GO

INSERT INTO clases_peticion (nombre)
VALUES
    ('General'),
    ('Por Acceso');
GO

INSERT INTO complejidades (nombre, dias_respuesta)
VALUES
...
INSERT INTO caracteristicas_calidad (nombre)
VALUES
    ('Seguridad'),
    ('Oportunidad'),
    ('Pertinencia'),
